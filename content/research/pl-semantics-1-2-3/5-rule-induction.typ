...
基础情况 $EE"-Base"$ 声明 $0$ 在集合 $EE$ 中；归纳情况 $EE"-Ind"$ 声明对于 $EE$ 中的任何数 $n$，数字 $n + 2$ 的结果也在 $EE$ 中。该定义的归纳性质意味着，集合 $EE$ 中除了通过有限次应用这两条规则所能得到的数字之外，没有任何其他东西，这有时被称为该定义的#term[极值子句 (extremal clause)]。
